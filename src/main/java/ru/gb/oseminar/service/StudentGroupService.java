package src.main.java.ru.gb.oseminar.service;

import src.main.java.ru.gb.oseminar.data.Student;
import src.main.java.ru.gb.oseminar.data.StudentComparator;
import src.main.java.ru.gb.oseminar.data.StudentGroup;
...
public class StudentGroupService {
    ...
    public Student getStudentFromStudentGroup(String firstName, String secondName) {
        ...
        while (iterator.hasNext()) {
            ...
            if (student.getFirstName().equalsIgnoreCase(firstName) && student.getSecondName().equalsIgnoreCase(secondName)) {
                result.add(student);
            }
        }
        if (result.size() == 0) {
